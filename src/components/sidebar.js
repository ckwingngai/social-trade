        ...
        <div className="scroll-sidebar">
          <ul id="sidebar-menu">
            ...
            <li className="no-menu">
              ...
              <span className="bs-label label-danger">
              NEW
              </span>
              </a>
            </li>
            ...
            <li>
              ...
              <span className="bs-label label-primary">Hot</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
            ...
            <li>
              ...
              <i className="glyph-icon icon-linecons-eye"></i>
              <span>Forms UI</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
            ...
            <li>
              <a href="#" title="Maps">
              <i className="glyph-icon icon-linecons-sound"></i>
              <span>Maps</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
            ...
            <li>
              <a href="#" title="Pages">
              <i className="glyph-icon icon-linecons-fire"></i>
              <span>Pages</span>
              <span className="bs-label badge-yellow">NEW</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
            ...
            <li>
              ...
              <i className="glyph-icon icon-linecons-cup"></i>
            ...
            <li>
              ...
              <i className="glyph-icon icon-linecons-mail"></i>
              <span>Mailbox</span>
              <span className="bs-badge badge-danger">3</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
            ...
            <li>
              ...
              <i className="glyph-icon icon-linecons-cd"></i>
              <span>Snippets</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
            ...
            <li>
              ...
              <i className="glyph-icon icon-linecons-doc"></i>
              <span>Helpers</span>
              </a>
              <div className="sidebar-submenu">
                <ul>
                  <li><a href="helper-classNamees.html" title="Helper classNamees"><span>Helper classNamees</span></a></li>
